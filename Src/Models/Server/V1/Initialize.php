	...
	public function initialize()
	{
		if ($this->isInit() === false) {
			...
			if ($this->getProtocol() ==  "tls") {
				...
				$fileObj	= \MTM\FS\Factories::getFiles()->getTempFile("pem")->setContent($certObj->getChainAsString());
				stream_context_set_option($ssl, "ssl", "local_cert", $fileObj->getPathAsString());
				
				$fileObj	= \MTM\FS\Factories::getFiles()->getTempFile("pem")->setContent($certObj->getPrivateKey()->get());
